...
namespace WebAPI.Migrations
{
    ...
    [Migration("20240622111456_ImageUrlPng")]
    partial class ImageUrlPng
    {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "43735104-a0a2-4a15-b45d-a7c9ddfa8b3b",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "fcea5b1b-29f3-48c7-8797-0033ae831fdc",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("WebAPI.Models.Cart", b =>
                {
                    b.HasOne("WebAPI.Models.AppUser", "AppUser")
                        .WithOne("Cart")
                        .HasForeignKey("WebAPI.Models.Cart", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
